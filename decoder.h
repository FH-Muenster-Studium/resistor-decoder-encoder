...
public:
    ...
    static bool colorToTemperatureCoefficient(Color color, uint8_t &multiplier);
    ...
    static bool decode6Band(Color color1, Color color2, Color color3, Color multiplier, Color tolerance, Color temperatureCoefficient, Resistor &resistor);
};
